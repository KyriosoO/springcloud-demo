...
@Schema(
    ...
    oneOf = {CapabilityChoiceArgs.class, DomainChoiceArgs.class, FieldChoiceArgs.class, ValueChoiceArgs.class},
...
public sealed interface ClarificationArgs
    permits CapabilityChoiceArgs, DomainChoiceArgs, FieldChoiceArgs, ValueChoiceArgs {
