...
/**
 * AgentPlan sealed union。只有 QueryAgentPlan 和 AggregateAgentPlan 两个合法子类型。
 *
...
@Schema(
    ...
    oneOf = {QueryAgentPlan.class, AggregateAgentPlan.class},
...
public sealed interface AgentPlan
    permits QueryAgentPlan, AggregateAgentPlan {
