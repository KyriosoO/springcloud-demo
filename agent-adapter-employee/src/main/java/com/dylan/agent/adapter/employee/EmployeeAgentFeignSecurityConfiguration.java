...
/** Employee Agent Client 始终使用 agent-service 服务身份，不透传最终用户 JWT。 */
public class EmployeeAgentFeignSecurityConfiguration {

    @Bean
    @Order(Ordered.LOWEST_PRECEDENCE)
    RequestInterceptor employeeAgentServiceTokenInterceptor(ServiceTokenProvider serviceTokenProvider) {
        return template -> {
