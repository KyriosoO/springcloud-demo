package com.dylan.baseline.documentprovider;
...
class DocumentProviderAdapterApplicationTest {
    ...
    void startsAsAnIsolatedEmptyService() {
        ...
        var applicationTypes = Arrays.stream(applicationContext.getBeanDefinitionNames())
                ...
                .filter(type -> type.getPackageName().startsWith("com.dylan.baseline.documentprovider"))
                .toList();
        assertThat(applicationTypes).containsExactly(DocumentProviderAdapterApplication.class);
