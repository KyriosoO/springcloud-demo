...
| 关联 L1 | [`L1_01`](L1_01_SINGLE_AGENT_KNOWLEDGE_QUERY_ARCHITECTURE.md) v1.3；[`L1_02`](L1_02_SINGLE_AGENT_BUSINESS_QUERY_ADAPTER_ARCHITECTURE.md) v2.4 |
...
修订历史：本文件为新建大版本权威基线；旧版本仅作为归档来源，不继承过程记录。v2.3 增加 Knowledge 可选生产接线、共享单动作与生命周期边界；v2.4 如实同步该接线和功能验收已实施；v2.5 同步域目录 v2、Summary v3、candidate-05 非 live 冻结和正式代码评审结论，不改变 Business QueryPlan 或公共 Runtime 合同。
...
| [`L2_01_00`](L2_01_00_SINGLE_AGENT_KNOWLEDGE_QUERY_FLOW_CONFIGURATION_DETAILED_DESIGN.md) v1.4 | Knowledge 开关、单注册、域目录 v2、任务绑定、阶段与组合根接线 |
| [`L2_01_01`](L2_01_01_SINGLE_AGENT_KNOWLEDGE_RETRIEVAL_LOCAL_MODEL_DETAILED_DESIGN.md) v1.3 | Knowledge typed HTTP、读取授权、RRF/rerank 与 client 生命周期 |
| [`L2_01_02`](L2_01_02_SINGLE_AGENT_KNOWLEDGE_EVIDENCE_EGRESS_SUMMARY_EFFECTIVENESS_DETAILED_DESIGN.md) v1.4 | Evidence/出域/Summary v3、功能与效果 UAT 分离及 candidate-05 非 live 候选 |
