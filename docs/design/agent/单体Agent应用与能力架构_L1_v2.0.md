...
| 当前版本 | v2.0 |
| 适用基线 | `AGENT-L0-001` v2.0；P1 最小实现已提交并通过单元验证，真实跨服务 PoC 与后续能力仍待核验 |
...
| v2.0-r10 | 2026-07-23 | 完成 Adapter 边界变更后的定向跨层复审：确认阶段 A 只经 Adapter 复用 Employee Search，并同步已提交实现与未关闭门禁。 |
