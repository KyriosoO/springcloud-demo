...
| 本次增量 | DR-KRET-033区分本地重排服务端口/health可达与推理就绪；启动期一次合成预热，不改变在线5秒及检索20秒合同；增量评审和实施状态归P3 |
...
- 当前版本：v2.14；DR-KRET-029/030已实施；DR-KRET-031的真实候选构建、全记录保持及同窗口检索对照通过；DR-KRET-032/033实施/执行状态归P3，旧批准基线保持原证明范围。
