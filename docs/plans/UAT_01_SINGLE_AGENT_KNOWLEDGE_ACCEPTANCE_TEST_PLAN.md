...
#### 14.44.3 相关性核对进度（8/24题）

沿§14.40/DR-KEV-033，以旧/新top20并集逐题核对。当前记录`retrieval_relevance.review.v1.jsonl`包含001～008的163项，全部483项中仍有320项未核对；不是独立盲评或外部专家批准。旧问题、gold和原始结果不变，既有结果中的null不被覆盖；额外分级复算由`retrieval_relevance_review.py`提供，整个24题的Precision/nDCG仍不汇总。首批81项保持字节不变，第二批82项仅追加并以首10行哈希保护，具体来源及验证见P3 §20.70。
