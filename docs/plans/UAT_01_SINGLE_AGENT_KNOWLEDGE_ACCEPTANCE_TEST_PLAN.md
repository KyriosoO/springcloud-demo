...
| 上位依据 | `L1_00` v3.5、`L1_01` v1.21、`L2_01_00` v1.28、`L2_01_01` v2.15、`L2_01_02` v1.24、`P3_00` v2.61；§14.39为run-12历史终态，§14.40治理分层计分，§14.41代表集基线，v1.37新增§14.42文号缺陷验证，不改旧case/gold/结果 |
