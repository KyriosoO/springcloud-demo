...
沿§14.40/DR-KEV-033，以旧/新top20并集逐题核对。当前记录`retrieval_relevance.review.v1.jsonl`只有001～004的81项，全部483项中仍有402项未核对；不是独立盲评或外部专家批准。旧问题、gold和原始结果不变，既有结果中的null不被覆盖；额外分级复算由`retrieval_relevance_review.py`提供，整个24题的Precision/nDCG仍不汇总。
