...
public final class DocumentReleaseGateEvaluator {
    ...
    public DocumentValidationModels.ReleaseGateEvidence evaluate(
            String unitType, String unitKeyDigest, String targetStateDigest,
        ...
        String digest = canonical("DRG-1", unitType, unitKeyDigest, targetStateDigest, reportDigest,
                approvalSafeRef, now.toString(), expiresAt.toString());
        return new DocumentValidationModels.ReleaseGateEvidence(
                "DRG-" + digest.substring(0, 20), unitType, unitKeyDigest, targetStateDigest,
