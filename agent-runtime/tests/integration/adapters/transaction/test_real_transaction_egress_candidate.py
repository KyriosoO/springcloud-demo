...
pytestmark = pytest.mark.skipif(
    os.environ.get("RUN_TRANSACTION_EGRESS_CANDIDATE_01") != "1",
    reason="requires exact GATE-026 opt-in",
)
...
def _context(token: str) -> CapabilityExecutionContext:
    return CapabilityExecutionContext(
        request_id="transaction-egress-candidate-01",
        correlation_id="transaction-egress-candidate-01",
...
@pytest.mark.asyncio
async def test_gate026_one_search_and_thirty_bounded_answers(
