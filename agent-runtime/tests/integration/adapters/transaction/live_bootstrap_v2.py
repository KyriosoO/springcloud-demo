...
RUN_ID: Final = "transaction-egress-live-bootstrap-v2-20260818-candidate-02"
AUTHORIZATION_REFERENCE: Final = "P3_00:GATE-061"
CANDIDATE_RUN_ID: Final = "transaction-egress-v4-20260817-candidate-04"
CANDIDATE_AUTHORIZATION_REFERENCE: Final = "P3_00:GATE-026"
...
BOOTSTRAP_ASSET_PATHS: Final = frozenset(
    {
        "agent-runtime/scripts/run-transaction-egress-live-bootstrap-candidate-02.ps1",
        ...
        "agent-runtime/tests/integration/adapters/transaction/live_bootstrap_v2.py",
        "agent-runtime/tests/integration/adapters/transaction/test_transaction_live_bootstrap_v2.py",
        "agent-runtime/tests/integration/adapters/transaction/test_transaction_live_bootstrap_v2_history.py",
        "agent-runtime/tests/integration/adapters/transaction/test_transaction_live_bootstrap_v2_preparation.py",
    }
)
BOOTSTRAP_HISTORY_PATHS: Final = frozenset(
    {
        "agent-runtime/tests/integration/adapters/transaction/evidence/transaction-egress-live-bootstrap-v1-20260817-candidate-01.manifest.json",
        "agent-runtime/tests/integration/adapters/transaction/evidence/transaction-egress-live-bootstrap-v1-20260817-candidate-01.authorization.json",
        "agent-runtime/tests/integration/adapters/transaction/evidence/transaction-egress-live-bootstrap-v1-20260817-candidate-01.lifecycle.jsonl",
        "agent-runtime/tests/integration/adapters/transaction/evidence/transaction-egress-live-bootstrap-v1-20260817-candidate-01.result.json",
        "agent-runtime/tests/integration/adapters/transaction/test_transaction_live_bootstrap_v1_failed_history.py",
        "agent-runtime/tests/integration/adapters/transaction/evidence/transaction-egress-v4-20260817-candidate-04.manifest.json",
        "agent-runtime/tests/integration/adapters/transaction/evidence/transaction-egress-v4-20260817-candidate-04.authorization.json",
...
class TransactionLiveBootstrapV2Operations:
    ...
    def _record_process_diagnostic(self, phase: str) -> None:
        ...
        if phase in {"auth_readiness", "auth_login"}:
            process = self.auth_process
            service = "auth-service"
        elif phase == "domain_readiness":
        ...
        try:
            ...
            diagnostic.write(
                path=output_paths(self.repository_root)[2],
    ...
    def _asset_preflight(self, _deadline_seconds: float) -> None:
        current = validate_prepared_assets_v2(
...
def run(*, repository_root: Path, expected_manifest_sha256: str) -> dict[str, object]:
    if os.environ.get("TRANSACTION_EGRESS_BOOTSTRAP_V2_LIVE_AUTHORIZED") != "1":
        raise BootstrapPhaseError("authorization_binding_invalid")
