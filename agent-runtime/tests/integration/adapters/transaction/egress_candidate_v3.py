...
RUN_ID: Final = "transaction-egress-v3-20260817-candidate-03"
PREPARATION_WORK_PACKAGE_ID: Final = "WP-TXN-EGRESS-CANDIDATE-03-PREP"
...
REQUIRED_ASSET_PATHS: Final = frozenset(
    {
        "agent-runtime/scripts/run-transaction-egress-live-candidate-03.ps1",
        ...
        "agent-runtime/tests/integration/adapters/transaction/egress_candidate_v3.py",
        "agent-runtime/tests/integration/adapters/transaction/egress_candidate_v3_host.py",
        "agent-runtime/tests/integration/adapters/transaction/"
        "test_real_transaction_egress_candidate_v3.py",
        "agent-runtime/tests/integration/adapters/transaction/"
        "test_transaction_egress_candidate_v3_harness.py",
        "agent-runtime/tests/integration/adapters/transaction/"
        "test_transaction_egress_candidate_v3_host.py",
        "agent-runtime/tests/integration/adapters/transaction/"
        "test_transaction_egress_candidate_v3_history.py",
        "agent-runtime/tests/integration/adapters/transaction/"
        "test_transaction_egress_candidate_v3_preparation.py",
        "agent-runtime/tests/integration/adapters/transaction/evidence/"
        "transaction-egress-candidate-v3-lifecycle.schema.json",
        "agent-runtime/tests/integration/adapters/transaction/evidence/"
        "transaction-egress-candidate-v3-result.schema.json",
        "agent-runtime/tests/integration/adapters/transaction/evidence/"
        "transaction-egress-candidate-v3-host-preflight.schema.json",
        "agent-runtime/tests/integration/adapters/transaction/evidence/"
        "transaction-egress-candidate-v3-host-result.schema.json",
    }
)
