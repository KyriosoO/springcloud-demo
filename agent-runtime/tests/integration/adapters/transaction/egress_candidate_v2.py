...
RUN_ID: Final = "transaction-egress-v2-20260817-candidate-02"
PREPARATION_WORK_PACKAGE_ID: Final = "WP-TXN-EGRESS-CANDIDATE-02-PREP"
...
REQUIRED_ASSET_PATHS: Final = frozenset(
    {
        "agent-runtime/scripts/run-transaction-egress-live-candidate-02.ps1",
        ...
        "agent-runtime/tests/integration/adapters/transaction/egress_candidate_v2.py",
        "agent-runtime/tests/integration/adapters/transaction/"
        "test_real_transaction_egress_candidate_v2.py",
        "agent-runtime/tests/integration/adapters/transaction/"
        "test_transaction_egress_candidate_v2_harness.py",
        "agent-runtime/tests/integration/adapters/transaction/"
        "test_transaction_egress_candidate_v2_history.py",
        "agent-runtime/tests/integration/adapters/transaction/"
        "test_transaction_egress_candidate_v2_preparation.py",
        "agent-runtime/tests/integration/adapters/transaction/evidence/"
        "transaction-egress-candidate-v2-lifecycle.schema.json",
        "agent-runtime/tests/integration/adapters/transaction/evidence/"
        "transaction-egress-candidate-v2-result.schema.json",
    }
)
