...
pytestmark = pytest.mark.skipif(
    os.environ.get("RUN_TRANSACTION_EGRESS_CANDIDATE_03") != "1",
    reason="requires exact GATE-026 candidate-03 opt-in",
)
...
def _context(token: str) -> CapabilityExecutionContext:
    return CapabilityExecutionContext(
        request_id="transaction-egress-candidate-03",
        correlation_id="transaction-egress-candidate-03",
...
@pytest.mark.asyncio
async def test_gate026_candidate03_one_search_and_thirty_bounded_answers(
