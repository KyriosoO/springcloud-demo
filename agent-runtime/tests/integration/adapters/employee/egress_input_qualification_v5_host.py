...
class QualificationV5HostError(ValueError):
    pass


def _invalid() -> NoReturn:
    raise QualificationV5HostError("employee.qualification_v5_host_contract_invalid")
...
def _load_records(path: Path) -> list[dict[str, Any]]:
    ...
    except (OSError, json.JSONDecodeError, QualificationV5HostError):
        _invalid()
