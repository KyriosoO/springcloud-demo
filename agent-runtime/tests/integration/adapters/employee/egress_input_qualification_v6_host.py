...
class QualificationV6HostError(ValueError):
    pass


def _invalid() -> NoReturn:
    raise QualificationV6HostError("employee.qualification_v6_host_contract_invalid")
...
def _load_records(path: Path) -> list[dict[str, Any]]:
    ...
    except (OSError, json.JSONDecodeError, QualificationV6HostError):
        _invalid()
