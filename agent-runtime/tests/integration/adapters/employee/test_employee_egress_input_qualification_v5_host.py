...
HOST_SCHEMA = EVIDENCE / "employee-egress-input-qualification-v5-host-lifecycle.schema.json"
FAILURE_SCHEMA = EVIDENCE / "employee-egress-input-qualification-v5-pre-sql-failure.schema.json"
MANIFEST_SHA = "a" * 64
...
def test_pre_sql_failure_rejects_successful_context_and_leaky_logs(tmp_path: Path) -> None:
    ...
    with pytest.raises(QualificationV5HostError, match="invalid"):
        write_pre_sql_failure(
