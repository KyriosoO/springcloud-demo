...
RUN_ID: Final = "employee-egress-v4-20260817-candidate-04"
PREPARATION_WORK_PACKAGE_ID: Final = "WP-EMP-EGRESS-CANDIDATE-04-PREP"
WORK_PACKAGE_ID: Final = "WP-EMP-EGRESS-01"
PREPARATION_GATE_ID: Final = "GATE-054"
...
HISTORY_ASSETS: Final = (
    ...
    (
        "egress_v3_manifest",
        "agent-runtime/tests/integration/adapters/employee/evidence/"
        "employee-egress-v3-20260817-candidate-03.manifest.json",
        "901ac019188e1eb15793aa93dd2add0444962f706539742ad6f5b087664ad16e",
    ),
    (
        "egress_v3_authorization",
        "agent-runtime/tests/integration/adapters/employee/evidence/"
        "employee-egress-v3-20260817-candidate-03.authorization.json",
        "a4dff9272a539f162fa0bd36fe88d3a1a3592c16294622cb6e9925f59896c4f8",
    ),
    (
        "egress_v3_lifecycle",
        "agent-runtime/tests/integration/adapters/employee/evidence/"
        "employee-egress-v3-20260817-candidate-03.lifecycle.jsonl",
        "da23d55c4aada51fe47bdd68ec2ec40a2895997e3050b04b21dba27f70ab8ce8",
    ),
    (
        "egress_v3_consumed",
        "agent-runtime/tests/integration/adapters/employee/evidence/"
        "employee-egress-v3-20260817-candidate-03.authorization.consumed.json",
        "e7def6942e153cea5787f503250c514e738f81cdea0a015ad47a948f782341a5",
    ),
    (
        "egress_v3_result",
        "agent-runtime/tests/integration/adapters/employee/evidence/"
        "employee-egress-v3-20260817-candidate-03.result.json",
        "2ab7a22476ba4e0b5ddd54ef4749b04ca2653c0bb7f4a811f1e78af20bb256a2",
    ),
)
...
REQUIRED_ASSET_PATHS: Final = frozenset(
    {
        ...
        "agent-runtime/tests/integration/adapters/employee/egress_candidate_v4.py",
        "agent-runtime/tests/integration/adapters/employee/test_employee_egress_candidate_v4_harness.py",
        "agent-runtime/tests/integration/adapters/employee/test_employee_egress_candidate_v4_preparation.py",
        "agent-runtime/tests/integration/adapters/employee/test_employee_egress_candidate_v4_history.py",
        "agent-runtime/tests/integration/adapters/employee/test_real_employee_egress_candidate_v4.py",
        "agent-runtime/tests/integration/adapters/employee/evidence/employee-egress-v4-lifecycle.schema.json",
        "agent-runtime/tests/integration/adapters/employee/evidence/employee-egress-v4-consumed.schema.json",
        "agent-runtime/tests/integration/adapters/employee/evidence/employee-egress-v4-staging.schema.json",
        "agent-runtime/tests/integration/adapters/employee/evidence/employee-egress-v4-pending.schema.json",
        "agent-runtime/tests/integration/adapters/employee/evidence/employee-egress-v4-result.schema.json",
        "employee-service/src/test/java/com/dylan/employee/live/EmployeeEgressCandidateV4LiveIntegrationTest.java",
    }
)


class EmployeeEgressCandidateV4Error(ValueError):
    pass


def _invalid() -> NoReturn:
    raise EmployeeEgressCandidateV4Error("employee.egress_candidate_v4_invalid")
