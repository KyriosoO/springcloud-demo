...
HOST_SCHEMA = EVIDENCE / "employee-egress-input-qualification-v6-host-lifecycle.schema.json"
FAILURE_SCHEMA = EVIDENCE / "employee-egress-input-qualification-v6-pre-sql-failure.schema.json"
MANIFEST_SHA = "a" * 64
...
def test_pre_sql_failure_rejects_successful_context_and_leaky_logs(tmp_path: Path) -> None:
    ...
    with pytest.raises(QualificationV6HostError, match="invalid"):
        write_pre_sql_failure(
