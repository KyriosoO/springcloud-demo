...
def test_amount_strings_parse_to_exact_decimal_and_mapper_uses_config_default_size() -> None:
    value = TransactionSearchArgumentValidator().validate({"amount": "100.0100"})
    assert value.amount == Decimal("100.0100")
...
@pytest.mark.parametrize("value", [0, 0.1, True, None, "01", "+1", "1e2", "1.00000", "10000000000000000"])
