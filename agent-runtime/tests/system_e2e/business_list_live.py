...
def uat_cases(*, transaction_type: str, employee_identifier: str) -> tuple[LiveCase, ...]:
    ...
    return (
        ...
        LiveCase(case_id="UAT-TXN-203", question="查询交易时间等于2020-01-01T00:00:00+08:00的交易", expected_action="transaction.search", expected_statuses=(CapabilityStatus.SUCCESS, CapabilityStatus.NO_RESULT), expected_fields=("trans_date",), expected_operators=("eq",)),
        LiveCase(case_id="UAT-TXN-205", question="查询交易金额等于0.01的交易", expected_action="transaction.search", expected_statuses=(CapabilityStatus.SUCCESS, CapabilityStatus.NO_RESULT), expected_fields=("amount",), expected_operators=("eq",)),
