...
_EXPECTED_CASES = {
    ...
    "bq-nonlive-emp-search-deny": ("forbidden", "employee.search"),
    "bq-nonlive-emp-search-ok": ("success", "employee.search"),
    "bq-nonlive-emp-semantic-deny": ("forbidden", "employee.semantic_search"),
    "bq-nonlive-emp-semantic-ok": ("success", "employee.semantic_search"),
    "bq-nonlive-invalid": ("invalid_argument", None),
    "bq-nonlive-invalid-operator": ("invalid_argument", None),
    "bq-nonlive-model-failure": ("downstream_failure", None),
    ...
    "bq-nonlive-unconfigured": ("unsupported", None),
