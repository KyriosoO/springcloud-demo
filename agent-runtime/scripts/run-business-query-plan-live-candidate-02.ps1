...
$expectedRunId = 'business-query-plan-live-v1-20260825-candidate-02'
...
$manifestPath = Join-Path $runtimeRoot 'tests\system_e2e\live\evidence\business-query-plan-live-v1-20260825-candidate-02.manifest.json'
