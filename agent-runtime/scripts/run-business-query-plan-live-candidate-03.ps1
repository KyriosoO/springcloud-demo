...
$expectedRunId = 'business-query-plan-live-v2-20260825-candidate-03'
...
$manifestPath = Join-Path $runtimeRoot 'tests\system_e2e\live\evidence\business-query-plan-live-v2-20260825-candidate-03.manifest.json'
...
try {
    ...
    ) -WorkingDirectory $runtimeRoot -WindowStyle Hidden -Wait -PassThru -RedirectStandardOutput $stdoutPath -RedirectStandardError $stderrPath
    $combined = @()
