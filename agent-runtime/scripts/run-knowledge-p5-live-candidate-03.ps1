...
$manifestPath = Join-Path $runtimeRoot 'tests\evaluation\knowledge\live\evidence\knowledge-p5-live-v1-20260813-candidate-03.manifest.json'
...
$datasetPath = Join-Path $runtimeRoot 'tests\evaluation\knowledge\representative_questions.v1.jsonl'
