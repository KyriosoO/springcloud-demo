...
/** 校验文档重建 sourceUrl，避免索引任务访问未授权地址。 */
@Component
public class DocumentSourceUrlPolicy {
	...
	public DocumentSourceUrlPolicy(EsQueryProperties properties) {
	...
	public void validate(String sourceUrl) {
		...
		List<String> allowedHosts = properties.getDocumentSourceAllowedHosts();
