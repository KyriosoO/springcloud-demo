package com.dylan.baseline.esquery;
...
class EsQueryServiceApplicationTest {
    ...
    void startsAsAnIsolatedEmptyService() {
        ...
        var applicationTypes = Arrays.stream(applicationContext.getBeanDefinitionNames())
                ...
                .filter(type -> type.getPackageName().startsWith("com.dylan.baseline.esquery"))
                .toList();
        assertThat(applicationTypes).containsExactly(EsQueryServiceApplication.class);
